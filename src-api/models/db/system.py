...
class StopgapDomain(BaseSqlModel):
    ...
    __tablename__ = f'{DB_PREFIX}_stopgap_domains'
    ...
    tenants = relationship('Tenant', back_populates='stopgap_domain', cascade='all, delete-orphan')
...
class RefTimezone(BaseSqlModel):
    ...
    __tablename__ = f'{DB_PREFIX}_ref_timezones'
    """Defines the database table name."""
