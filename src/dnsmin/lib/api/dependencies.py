...
from dnsmin.lib.permissions.definitions import Permission
...
async def get_db_session() -> AsyncGenerator[AsyncSession, None]:
    ...
    from dnsmin.app import AsyncSessionLocal
...
async def get_principal(
    ...
    from dnsmin.models.db.auth import Session, Client
...
async def authorize_oauth_client(
    ...
    from typing import Optional
    from dnsmin.lib.security import TokenGrantTypeEnum, TokenErrorTypeEnum, TENANT_HEADER_NAME
    from dnsmin.lib.tenants import TenantManager
    from dnsmin.models.db.auth import Client
