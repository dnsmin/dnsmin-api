...
from dnsmin.lib.enums import NotificationServiceEnum, TaskEnum
from dnsmin.lib.notifications.config import (
...
from dnsmin.lib.notifications.events import ALL_EVENTS, ALL_EVENTS_TYPE
...
class MailNotificationSender(NotificationSender):
    ...
    def send(self, recipient: MailServiceRecipient):
        ...
        celery_app.send_task(TaskEnum.APP_MAIL_SEND.value, kwargs=conf)
...
class MsTeamsNotificationSender(NotificationSender):
    ...
    def send(self, recipient: MsTeamsServiceRecipient):
        ...
        import requests
        from loguru import logger
        from dnsmin.lib.services.microsoft.adaptivecards import ContainerStyleEnum
        from dnsmin.lib.services.microsoft.teams import MessageFactory
