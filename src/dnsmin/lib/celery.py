...
from dnsmin.models.db.tasks import TaskJob
...
class DynamicScheduler(Scheduler):
    ...
    def build_beat_schedule(self) -> dict:
        ...
        from loguru import logger
        from dnsmin.lib import load_config, load_schedules
        from dnsmin.lib.util.dt import TimeUtil
...
class SignalHandler:
    ...
    def save_task_job(self, task_job: TaskJob, create_activity: bool = True):
        ...
        from sqlalchemy.orm.exc import UnmappedInstanceError
        from dnsmin.app import SessionLocal
        from dnsmin.models.db.tasks import TaskJobActivity
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def worker_process_init_handler(self, **kwargs):
        ...
        from dnsmin.app import app_startup
    ...
    def worker_process_shutdown_handler(self, **kwargs):
        ...
        from dnsmin.app import app_shutdown
        app_shutdown(use_sync=True)

    def task_received_handler(self, request: Request, **kwargs):
        from loguru import logger
        from dnsmin.app import notifications
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskReceivedEvent
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_revoked_handler(self, request: Context, terminated: bool, signum: int, expired: bool, **kwargs):
        from loguru import logger
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskRevokedEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_rejected_handler(self, message: str, exc: Exception, **kwargs):
        ...
        from dnsmin.app import notifications
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskRejectedEvent
    ...
    def task_pre_run_handler(self, task_id: str, task: Task, **kwargs):
        ...
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskPreRunEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_post_run_handler(self, task_id: str, task: Task, **kwargs):
        ...
        from dnsmin.app import notifications
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskPostRunEvent
    ...
    def task_retry_handler(self, request: Context, reason: str, einfo: ExceptionInfo, **kwargs):
        ...
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskRetryEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_internal_error_handler(self, task_id: str, args, kwargs, request: Request, exception, traceback, einfo: ExceptionInfo, **kw):
        ...
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskInternalErrorEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_success_handler(self, sender, result: Any, **kwargs):
        ...
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskSuccessEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_failure_handler(self, sender, task_id: str, exception: Exception, args, kwargs, traceback, einfo: ExceptionInfo, **kw):
        ...
        from dnsmin.app import notifications, zabbix
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskFailedEvent
        from dnsmin.lib.services.zabbix import ZabbixMetric
        from dnsmin.models.enums import TaskJobStatusEnum
    ...
    def task_unknown_handler(self, name: str, id: str, message: Message, exc: Exception, **kw):
        ...
        from dnsmin.lib.notifications import NotificationManager
        from dnsmin.lib.notifications.events import TaskUnknownEvent
        ...
        if name not in self._ignored_tasks:
            self.app.send_task(TaskEnum.APP_ALERT.value, kwargs={'msg': msg, 'info': f'{message}\n\n{exc}'})
