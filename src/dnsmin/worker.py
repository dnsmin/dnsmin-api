...
from dnsmin.lib import load_config, init_logging
from dnsmin.lib.celery import SignalHandler
...
# Configure Celery
app.conf.beat_scheduler = 'src.dnsmin.lib.celery.DynamicScheduler'
...
root_task_path = f'src/dnsmin/tasks'
task_packages = []
...
for dirpath, _, filenames in os.walk(root_task_path):
    for filename in filenames:
        if filename.endswith('.py') and filename != '__init__.py':
            ...
            task_packages.append(f'dnsmin.tasks.{module}')
