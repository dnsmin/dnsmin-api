...
from dnsmin.lib.pda.api.services.mail import MailServiceSendRequest, MailServiceSendResponse
...
async def send(request: MailServiceSendRequest, wait_for_finish: bool = False, timeout: float = 60) -> JSONResponse:
    ...
    try:
        ...
        task: AsyncResult = celery_app.send_task(TaskEnum.APP_MAIL.value, kwargs={
