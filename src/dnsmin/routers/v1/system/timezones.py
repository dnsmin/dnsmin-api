...
from dnsmin.models.api.system.timezones import TimezonesSchema, TimezoneOutSchema, TimezoneInSchema
from dnsmin.routers.v1.system import router
...
async def record_list(
    ...
    from dnsmin.models.db.system import RefTimezone
