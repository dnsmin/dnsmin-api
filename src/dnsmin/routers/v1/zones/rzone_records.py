...
from dnsmin.models.api.zones.rzone_records import RZoneRecordInSchema, RZoneRecordOutSchema, RZoneRecordsSchema
...
async def record_list(
    ...
    from dnsmin.models.db.zones import RZoneRecord
