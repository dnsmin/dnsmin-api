...
from dnsmin.models.api.zones.azone_crypto_keys import AZoneCryptoKeyInSchema, AZoneCryptoKeyOutSchema, AZoneCryptoKeysSchema
...
async def record_list(
    ...
    from dnsmin.models import AZoneCryptoKey
