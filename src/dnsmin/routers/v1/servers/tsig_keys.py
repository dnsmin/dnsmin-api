...
from dnsmin.models.api.servers.tsig_keys import ServerTSIGKeysSchema, ServerTSIGKeyOutSchema, ServerTSIGKeyInSchema
...
async def record_list(
    ...
    from dnsmin.models.db.servers import ServerTsigKey
