...
from dnsmin.lib.api.dependencies import get_db_session, authorize_oauth_client
from dnsmin.routers.root import router_responses
from dnsmin.routers.v1 import router as v1_router
...
async def token(
    ...
    from dnsmin.lib.api.oauth import create_access_token
    from dnsmin.models.db.auth import RefreshToken
...
async def token_refresh(
    ...
    from dnsmin.lib.security import TokenGrantTypeEnum, TokenErrorTypeEnum
    from dnsmin.lib.settings import SettingsManager
    from dnsmin.lib.settings.definitions import sd
    from dnsmin.lib.api.oauth import create_access_token
    from dnsmin.models.db.auth import Client, RefreshToken
