...
AWS ARN except known as "DARN". Here is how that reference is structured:

> darn:tenant-id:app-id:resource-type:resource-id:permission-flags
...
each app to provide references to DARN patterns provided by that app as well as what permissions are available for
each DARN pattern. This essentially makes the RBAC pluggable for new developments as defining new capabilities in app
components becomes very easy and fast. This approach also makes supporting completely fluid permissions structures
possible.

#### Examples

In practice, here is what some DARNs would look like:
...
> darn:4321:settings/ui/web:site-title:u
...
> darn:4321:zones/example.com/txt/@:123:ddu
...
> darn:4321:zones/example.com/a:stage:r
