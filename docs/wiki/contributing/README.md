...
* [Pull requests](https://docs.github.com/en/pull-requests) (a feature of GitHub) are used to propose changes to DNSMin's code base. Our process generally goes like this:
...
We're always looking for motivated individuals to join the maintainers team and help drive DNSMin's long-term development. Some of our most sought-after skills include:
...
Some maintainers petition their employer to grant some of their paid time to work on DNSMin.

Interested? You can contact our lead maintainer, Matt Scott, at matt@dnsmin.org. We'd love to have you on the team!
